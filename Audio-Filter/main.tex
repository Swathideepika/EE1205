...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11061 - VARASALA SWATHI DEEPIKA $^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
$https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/swathi.wav
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/code1.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/code1.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/code2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/code3.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/code4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/code5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/code6.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/code7.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/code8.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/code9.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/code10.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Swathideepika/EE1205/blob/main/Audio-Filter/codes/code11.py
\end{lstlisting}
\begin{figure}[H]
\centering
