...
And the corresponding frequency domain representation:
\begin{align}
...
Expanding:
\begin{align}
Y(e^{j\omega}) &= 1 - e^{-j\omega} + 2.5e^{-3j\omega} - 0.5e^{-j2\omega} - e^{-j5\omega}
\end{align}

Taking the inverse discrete-time Fourier transform (IDTFT):
\begin{align}
